...
import { PostStatusbarComponent } from './post-statusbar.component';
...
describe('PostStatusbarComponent', () => {
  const createComponent = createComponentFactory({
    component: PostStatusbarComponent,
  ...
  let spectator: Spectator<PostStatusbarComponent>;
  let component: PostStatusbarComponent;
